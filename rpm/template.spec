Name:           ros-hydro-rmp-description
Version:        0.0.2
Release:        0%{?dist}
Summary:        ROS rmp_description package
...
%description
The rmp_description package provides Unified Robot Description Format files to
represent a Segway Robotics Mobility Platform.
